...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { PublicApiController } from "./../src/api/controllers/PublicApiController";
...
export function RegisterRoutes(app: express.Router) {
    ...
    app.get(
        ...
        async function PublicApiController_test(request: any, response: any, next: any) {
            const args = {
            ...
            try {
                ...
                const container: IocContainer =
                    typeof iocContainer === "function" ? (iocContainer as IocContainerFactory)(request) : iocContainer;

                const controller: any = await container.get<PublicApiController>(PublicApiController);
